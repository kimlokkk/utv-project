        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <h3 class="card-header bg-info text-white">Status</h3>
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $query = "
                                                SELECT *, 'Consultancy' AS project_source
                                                FROM consultancy_project_members
                                                WHERE leader_id = '$user_id'
                                                
                                                UNION ALL
                                                
                                                SELECT *, 'Training' AS project_source
                                                FROM training_project_members
                                                WHERE leader_id = '$user_id'

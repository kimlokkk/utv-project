        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">RA/RO Listing</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <h3 class="card-header bg-info text-white">List of RA/RO Application</h3>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <?php if (!$isInternalLevel3Review && (stripos($status, 'Rejected') !== false || stripos($status, 'Returned') !== false)) { ?>
                                                        <a href="ra-application-edit.php?id=<?php echo urlencode($raa_id); ?>" class="btn btn-warning btn-sm">
                                                            Edit
                                                        </a>
                                                    <?php } ?>
                                                </td>
                                            ...
                                            <?php 
                                                    ...
                                                    echo '<tr><td colspan="7" class="text-center text-danger">No research assistants found for your approved projects.</td></tr>';
                                                }
                                            ?>
                                        </tbody>
                                    </table>

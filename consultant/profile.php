                        ...
                        <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-body">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" name="staff_id" value="<?php echo $userData['staff_id']; ?>" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <label>PTJ and Address (Secondary)</label>
                                                        <textarea class="form-control" name="ptj_address_2" rows="3"><?php echo $userData['ptj_address_2']; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row m-t-20 m-b-30">
                                <div class="col-md-12">
                                    ...
                                    <button type="submit" class="btn btn-lg btn-info" name="btn_updateProfileConsultant"> Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>

        ...
        echo "<script>
            document.addEventListener('DOMContentLoaded', function() {
                Swal.fire({
                    ...
                    window.location.replace('training-project-info.php?id={$id}');
                });
            });
        </script>";
    }
...
<body class="skin-blue fixed-layout">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Edit Training Project</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <!-- Project Details -->
                            <div class="card">
                                <h3 class="card-header bg-info text-white">Training Project</h3>
                                <div class="card-body">
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="client_pic" value="<?php echo $client_pic; ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Person in Charge Email Address</label>
                                                    <input type="email" name="client_pic_email" value="<?php echo $client_pic_email; ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Person in Charge Contact Number</label>
                                                    <input type="phone" name="client_pic_contact" value="<?php echo $client_pic_contact; ?>" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row m-t-30 m-b-30">
                                <div class="col-md-12">
                                    ...
                                    <button 
                                      type="submit"
                                      name="btn_updateTrainingProject"
                                      class="btn btn-lg btn-info"
                                      formnovalidate
                                      onclick="document.getElementById('action').value='save';"
                                    >Save</button>
                                    <!--<button type="submit" name="btn_submitTrainingProject" class="btn btn-lg btn-success"> Submit</button>-->
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const submitButton = document.querySelector("button[name='btn_submitTrainingProject']");
            const updateButton = document.querySelector("button[name='btn_updateTrainingProject']");

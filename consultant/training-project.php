        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <h3 class="card-header bg-info text-white">List of Training Project</h3>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    } elseif (stripos($project_status, 'Pending Approval') !== false || stripos($project_status, 'Pending Verification') !== false || stripos($project_status, 'Pending Submission') !== false) {
                                                ...
                                                <td class="text-center">
                                                    <a href="training-project-info.php?id=<?php echo urlencode($project_id); ?>" class="btn waves-effect waves-light btn-info assign-button" title="Full Info">Full Info</a>
                                                </td>
                                            </tr>
                                            <?php 
                                                $counter++;

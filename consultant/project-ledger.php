    ...
    */
	    ...
	    if (!isset($_GET['projectId']) || empty($_GET['projectId'])) {
	        echo '<script>
	            ...
	            window.location.href = "project-ledger-list.php";
	        </script>';
	        exit();
	    }
    ...
    $project_result = mysqli_query($db, $project_query);
	    ...
	    $member_check_query = "
	        ...
	        LIMIT 1
	    ";
	    $member_check_result = mysqli_query($db, $member_check_query);
	    $is_project_member = $member_check_result && mysqli_num_rows($member_check_result) > 0;

	    if ((string)$project['leader_id'] !== (string)$user_id && !$is_project_member) {
	        echo '<script>
	            alert("You are not allowed to view this project ledger.");
	            window.location.href = "project-ledger-list.php";
	        </script>';
	        exit();
	    }
                            ...
                            <div class="card-body">
                                <div class="ledger-header">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 text-right ledger-action-bar">
	                                            ...
	                                            <a href="project-ledger-list.php" class="btn btn-secondary">
	                                                Back
	                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex flex-wrap justify-content-between align-items-center m-b-10">
                                    ...
                                    <div class="btn-group btn-group-sm" role="group" aria-label="Ledger view mode">
	                                        <button type="button" id="ledgerCompactView" class="btn btn-info active">Compact View</button>
	                                        <button type="button" id="ledgerFullView" class="btn btn-outline-info">Full Details</button>
                                    </div>
                                </div>
        ...
        $(function () {
            ...
            function setLedgerViewMode(mode) {
                ...
                setTimeout(function() {
	                ...
	                $('#ledgerCompactView')
	                    .toggleClass('active btn-info', isCompact)
	                    .toggleClass('btn-outline-info', !isCompact);

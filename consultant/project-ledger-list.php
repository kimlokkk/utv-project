        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
	                            <h3 class="card-header bg-info text-white">List of Project</h3>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="projectLedgerTable" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Project No</th>
                                                <th>Project Title</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $query = "
	                                                    SELECT *
	                                                    FROM project
	                                                    WHERE (project_status = 'Approved' OR project_status = 'Appointed')
	                                                    AND (
	                                                        leader_id = '$user_id'
	                                                        OR EXISTS (
	                                                            SELECT 1
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="project-ledger.php?projectId=<?php echo urlencode($project_id); ?>" 
	                                                       class="btn waves-effect waves-light btn-info assign-button" 
	                                                       title="View Ledger">
	                                                       View Ledger
                                                    </a>

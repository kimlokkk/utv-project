...
<?php
    $id                 =   $_GET['id'];
    $query              =   "SELECT * FROM consultancy_project WHERE id = '$id' ";  
    ...
    $tracking_query = "SELECT * FROM consultancy_project_tracker WHERE project_id = '$id' ORDER BY date DESC";
                        ...
                        <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Registered Project Value (RM)</label>
                                                    <input type="number" name="registered_project_value" value="<?php echo $registered_project_value; ?>" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Adjusted Project Value (RM)</label>
                                                    <input type="number" name="adjusted_project_value" value="<?php echo $adjusted_project_value; ?>" class="form-control" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Approval to Undertake External Work</label>
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            <input type="file" name="project_proposal" class="custom-file-input" id="inputGroupFile05" <?php echo empty($project_proposal) ? 'required' : ''; ?>>
                                ...
                                <div class="card-body">
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Client's Company Name</label>
                            ...
                            <div class="row m-t-30 m-b-30">
                                <div class="col-md-12">
                                    ...
                                    <button type="update" name="btn_updateConsultancyProject" class="btn btn-lg btn-info"> Update</button>&nbsp;&nbsp;
    ...
    <script>  
        ...
        var i = 1;
            $('#add').click(function () {
                ...
                /*newRow.append('<td><select class="form-control name_list" name="program[]" id="program">' +
                ...
                var therapistSelect = $('<td><select class="select2 form-control custom-select" name="stud_therapist[]" style="width:100%;">' +
    ...
    <script>  
        $(document).ready(function () {
            ...
            $('#add2').click(function () {
                ...
                var timelineInput = $('<td><input type="text" class="form-control" name="project_timeline[]" placeholder="Enter Project Timeline" /></td>');
        
                // Create Value (RM) input
                var valueInput = $('<td><input type="text" class="form-control" name="project_value[]" placeholder="Enter Value (RM)" /></td>');

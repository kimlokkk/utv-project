...
<body class="skin-blue fixed-layout">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <!-- Vendor Details -->
                        <div class="card">
                            <h3 class="card-header bg-info text-white">Vendor Details</h3>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                ...
                $disableButtons = $isNotLeader || $isRejected;
                ?>
                <div class="row m-b-30">
                    <div class="col-md-12">
                        <button type="button" id="submitProcurement" class="btn btn-lg btn-success"
                        ...
                        <button type="button" id="rejectProcurement" class="btn btn-lg btn-danger"
                            data-procurement-id="<?php echo $procurement_id; ?>"
                            data-project-id="<?php echo $project_id; ?>"
                            data-project-no="<?php echo $project_no; ?>"
                            <?php echo $disableButtons ? 'disabled style="opacity: 0.5; cursor: not-allowed;"' : ''; ?>>
    ...
    <script>
       $(document).on('click', '#submitProcurement', function () {
        Swal.fire({
            title: 'Are you sure?',
            text: "Once approve, you cannot edit this procurement!",
            icon: 'warning',
            ...
            if (result.isConfirmed) { // Guna .isConfirmed, bukan .value
                ...
                Swal.fire(
                    'Cancelled',
                    'Procurement submission has been cancelled.',
                    'info'
                );
            }
        });
    ...
    <script>
       $(document).on('click', '#rejectProcurement', function () {
            ...
            Swal.fire({
                title: 'Are you sure you want to reject this procurement?',
                input: 'textarea',
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire('Cancelled', 'Procurement rejection has been cancelled.', 'info');
                }
            });
        });
    </script>

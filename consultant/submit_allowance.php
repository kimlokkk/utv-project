<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') { // Gunakan GET
        ...
        $remark = "Allowance/wages application for $member_name has been submitted by project leader.";
        ...
        try {
            ...
            echo json_encode(['success' => true, 'message' => 'Allowance/wages application has been successfully submitted and tracked!']);
        } catch (Exception $e) {

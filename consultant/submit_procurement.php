<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') { // Gunakan GET
        ...
        $remark = "Procurement application has been submitted by project leader.";
        ...
        try {
            ...
            echo json_encode(['success' => true, 'message' => 'Procurement has been successfully submitted and tracked!']);
        } catch (Exception $e) {

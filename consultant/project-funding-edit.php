...
$query = "
    SELECT pfa.*, p.project_no, p.project_title, p.project_leader, p.leader_id, p.client_company_name
...
if (!$result || mysqli_num_rows($result) === 0) {
    echo '<script>alert("This application cannot be edited."); window.location.href = "project-funding.php";</script>';
    exit;
}
...
<body class="skin-blue fixed-layout">
            ...
            <div class="container-fluid">
                ...
                <form id="projectFundingEditForm">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="alert alert-warning">
                                Update the returned/rejected application and resubmit it.
                    ...
                    <div class="row m-t-30 m-b-30">
                        <div class="col-md-12">
                            <button type="button" id="submitProjectFundingEdit" class="btn btn-lg btn-success">Resubmit</button>
    ...
    <script>
        ...
        document.getElementById('addFundingRow').addEventListener('click', function() {
            ...
            row.innerHTML = `
                <td><select name="category[]" class="form-control" required>${categoryOptions}</select></td>
                ...
                <td class="text-center"><button type="button" class="btn btn-danger btn-sm removeRow">&times;</button></td>
            `;
            document.getElementById('fundingBody').appendChild(row);
        });

        document.addEventListener('click', function(e) {
            if (e.target && e.target.classList.contains('removeRow') && document.querySelectorAll('#fundingBody tr').length > 1) {
        ...
        $('#submitProjectFundingEdit').on('click', function() {
            ...
            Swal.fire({
                ...
                text: 'This will submit the corrected project funding assistance application.',
                icon: 'warning',
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response && response.success) {
                                Swal.fire('Submitted!', response.message, 'success').then(() => window.location.href = 'project-funding.php');
                            } else {

...
<head>
    ...
    <title>IProms | UiTM Staff Registration</title>
    ...
    <div class="page-wrapper">
        <div class="container-fluid">
                ...
                <div class="admin-hero-inner">
                    <div class="brand-group">
                        ...
                        <div class="hero-text">
                            ...
                            <p>UiTM Staff registration and account setup</p>
                        </div>
                    </div>
                    <div class="hero-badge">Staff Registration Module</div>
                </div>
            </div>
            ...
            <div class="intro-card">
                <h1>UiTM Staff Registration Form</h1>
                <p>
                    Complete the information below to register your staff profile. Please ensure all required details are accurate and that uploaded documents follow the permitted file format requirements.
                </p>
            </div>

            <form method="POST" enctype="multipart/form-data" id="uitmStaffForm">

                <div class="section-card">
                    <div class="section-header">
                        <h3>Account & Personal Information</h3>
                        <p>Set your login details and complete your personal and staff information.</p>
                    </div>
                    <div class="section-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" value="<?php echo isset($_POST['password']) ? $_POST['password'] : '' ?>" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Re-Type Password <span class="text-danger">*</span></label>
                                    <input type="password" name="password_confirm" data-validation-match-match="password" value="<?php echo isset($_POST['password_confirm']) ? $_POST['password_confirm'] : '' ?>" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="full_name" value="<?php echo isset($_POST['full_name']) ? $_POST['full_name'] : '' ?>" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="designation" class="form-control" required>
                                        ...
                                        <option value="Associate Professor Dr">Associate Professor Dr</option>
                                        <option value="Associate Professor">Associate Professor</option>
                                        <option value="Dr">Dr</option>
                                        <option value="Mr">Mr</option>
                                        <option value="Ms">Ms</option>
                                        <option value="Miss">Miss</option>
                                        <option value="Tan Sri Professor Dr">Tan Sri Professor Dr</option>
                                        <option value="Dato Sri Professor Dr">Dato Sri Professor Dr</option>
                                        <option value="Dato Professor Dr">Dato Professor Dr</option>
                                        <option value="Datuk Professor Dr">Datuk Professor Dr</option>
                                        <option value="Datin Professor Dr">Datin Professor Dr</option>
                                        <option value="Puan Sri Professor Dr">Puan Sri Professor Dr</option>
                                        <option value="Dato Sri Assoc Prof Dr">Dato Sri Assoc Prof Dr</option>
                                        <option value="Dato Assoc Prof Dr">Dato Assoc Prof Dr</option>
                                        <option value="Datuk Assoc Prof Dr">Datuk Assoc Prof Dr</option>
                                        <option value="Datin Assoc Prof Dr">Datin Assoc Prof Dr</option>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="staff_id" value="<?php echo isset($_POST['staff_id']) ? $_POST['staff_id'] : '' ?>" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="id-input" name="ic" value="<?php echo isset($_POST['ic']) ? $_POST['ic'] : '' ?>" class="form-control mt-2" placeholder="Enter IC or Passport" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Mobile No <span class="text-danger">*</span></label>
                                    <input type="tel" id="phone-mask-me" name="phone" value="<?php echo isset($_POST['phone']) ? $_POST['phone'] : '' ?>" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>No TIN</label>
                                    <input type="text" name="tin_no" value="<?php echo isset($_POST['tin_no']) ? $_POST['tin_no'] : '' ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" value="<?php echo isset($_POST['email']) ? $_POST['email'] : '' ?>" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Alternate Email Address</label>
                                    <input type="email" name="email_2" value="<?php echo isset($_POST['email_2']) ? $_POST['email_2'] : '' ?>" class="form-control">
                                </div>
                            </div>
                        </div>

                        <div class="subheading mt-3">Permanent Campus Information</div>

                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>UiTM State (Permanent) <span class="text-danger">*</span></label>
                                    <select class="form-control" id="uitm_state_permanent" name="uitm_state_permanent" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>PTJ (Permanent)<span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Campus Address (Permanent) <span class="text-danger">*</span></label>
                                    <textarea class="form-control" id="campus_address_permanent" name="campus_address_permanent" rows="3" required></textarea>
                                </div>
                            </div>
                        </div>

                        <div class="subheading mt-3">Current Campus Information</div>
                        ...
                        <div class="copy-box">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="sameAsPermanent">
                                    Same as Permanent Information
                                </label>
                            </div>
                            <div class="helper-text">If checked, Current State and Current Campus Address will be auto-filled from Permanent information.</div>
                        </div>

                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>UiTM State (Current) <span class="text-danger">*</span></label>
                                    <select class="form-control" id="uitm_state_current" name="uitm_state_current" required>
                                        <option value="" disabled selected>Select State</option>
                                        <option value="Selangor">Selangor</option>
                                        <option value="Kuala Lumpur">Kuala Lumpur</option>
                                        <option value="Negeri Sembilan">Negeri Sembilan</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Campus Address (Current) <span class="text-danger">*</span></label>
                                    <textarea class="form-control" id="campus_address_current" name="campus_address_current" rows="3" required></textarea>
                                </div>
                            </div>
                        </div>

                        <div class="subheading mt-3">Additional Information</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="expertise" value="<?php echo isset($_POST['expertise']) ? $_POST['expertise'] : '' ?>" class="form-control" required>
                                </div>
                            </div>
                        </div>
                ...
                <div class="section-card">
                    <div class="section-header">
                        ...
                        <p>Select your bank from the approved list and upload supporting documents in PDF or image format only.</p>
                    </div>
                    <div class="section-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_account" id="no_account" value="<?php echo isset($_POST['no_account']) ? $_POST['no_account'] : '' ?>" class="form-control" required maxlength="30" inputmode="numeric">
                ...
                <div class="action-card">
                    <div class="action-wrap">
                        ...
                        <div>
                            ...
                            <button type="submit" name="btn_registerConsultant" class="btn btn-admin-primary">Submit Registration</button>
                        </div>
                    </div>
                </div>
...
$(document).ready(function () {
    ...
    function syncCurrentWithPermanent() {
        if ($('#sameAsPermanent').is(':checked')) {
            $('#uitm_state_current').val($('#uitm_state_permanent').val()).trigger('change');
            $('#campus_address_current').val($('#campus_address_permanent').val());
            $('#uitm_state_current').prop('readonly', true);
            $('#campus_address_current').prop('readonly', true);
        } else {
            $('#uitm_state_current').prop('readonly', false);
            $('#campus_address_current').prop('readonly', false);
        }
    }

    $('#sameAsPermanent').on('change', syncCurrentWithPermanent);
    $('#uitm_state_permanent, #campus_address_permanent').on('change keyup', function () {
        if ($('#sameAsPermanent').is(':checked')) {
    ...
    $('#uitmStaffForm').on('submit', function(e) {
        e.preventDefault();
        ...
        formData.append('btn_registerConsultant', '1');

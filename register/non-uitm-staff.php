...
<head>
    ...
    <title>IProms | Non-UiTM Staff Registration</title>
    ...
    <div class="page-wrapper">
        <div class="container-fluid">
                ...
                <div class="admin-hero-inner">
                    <div class="brand-group">
                        ...
                        <div class="hero-text">
                            ...
                            <p>Non-UiTM Staff registration and account setup</p>
                        </div>
                    </div>
                    <div class="hero-badge">External Registration Module</div>
                </div>
            </div>
            ...
            <div class="intro-card">
                <h1>Non-UiTM Staff Registration Form</h1>
                <p>
                    Complete the information below to register your external profile. Please ensure all required details are accurate and that uploaded documents follow the permitted file format requirements.
                </p>
            </div>

            <form method="POST" enctype="multipart/form-data" id="nonUitmStaffForm">

                <div class="section-card">
                    <div class="section-header">
                        <h3>Account & Personal Information</h3>
                        <p>Set your login details and complete your personal, employment and tax information.</p>
                    </div>
                    <div class="section-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password_confirm" value="<?php echo isset($_POST['password_confirm']) ? $_POST['password_confirm'] : '' ?>" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="subheading mt-3">Organisation Information</div>
                        ...
                        <div class="subheading mt-3">Permanent Address</div>

                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Company / Permanent Address <span class="text-danger">*</span></label>
                                    <textarea class="form-control" id="company_address_permanent" name="company_address_permanent" rows="3" required><?php echo isset($_POST['company_address_permanent']) ? $_POST['company_address_permanent'] : '' ?></textarea>
                                </div>
                            </div>
                        </div>

                        <div class="subheading mt-3">Current Address</div>
                        ...
                        <div class="copy-box">
                            ...
                            <div class="helper-text">If checked, Current Address will be auto-filled from Permanent Address.</div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="company_address_current" name="company_address_current" rows="3" required><?php echo isset($_POST['company_address_current']) ? $_POST['company_address_current'] : '' ?></textarea>
                                </div>
                            </div>
                        </div>
                ...
                <div class="action-card">
                    <div class="action-wrap">
                        ...
                        <div>
                            ...
                            <button type="submit" name="btn_registerNonUitmStaff" class="btn btn-admin-primary">Submit Registration</button>
                        </div>
                    </div>
                </div>
...
$(document).ready(function () {
    ...
    function syncCurrentWithPermanent() {
        if ($('#sameAsPermanent').is(':checked')) {
            $('#company_address_current').val($('#company_address_permanent').val());
            $('#company_address_current').prop('readonly', true);
        } else {
            $('#company_address_current').prop('readonly', false);
        }
    }

    $('#sameAsPermanent').on('change', syncCurrentWithPermanent);
    $('#company_address_permanent').on('keyup change', function () {
        if ($('#sameAsPermanent').is(':checked')) {
    ...
    $('#nonUitmStaffForm').on('submit', function(e) {
        e.preventDefault();
        ...
        formData.append('btn_registerNonUitmStaff', '1');

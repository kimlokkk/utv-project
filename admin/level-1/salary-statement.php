                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Abcd Project</td>
                                                <td>Dr. A</td>
                                                <td>01/01/2024-31/12/2024 (12 Months)</td>
                                                <td>6 Months</td>
                                                <td>Active</td>
                                                <td>Salary</td>
                                                <td>RM2000</td>
                                                <td class="text-center"><a href="preview.php<?php //echo $stud_id; ?>" class="btn waves-effect waves-light btn-info assign-button" title="Preview">Preview</a></td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>Training</td>
                                                ...
                                                <td>Efgh Training</td>
                                                <td>Dr. B</td>
                                                <td>01/05/2024- 31/12/2024 (7 months)</td>
                                                <td>2 Months</td>
                                                <td>Active</td>
                                                <td>Allowance</td>
                                                <td>RM1800</td>

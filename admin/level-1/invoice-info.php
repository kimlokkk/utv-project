                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if (response.success) {
                                    ...
                                    Swal.showValidationMessage(response.message || 'Failed to approve invoice.');
                                    reject();
                                }
                            },
                            error: function (xhr) {
    ...
    <script>
       $(document).on('click', '#rejectInvoice', function () {
            ...
            Swal.fire({
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if (response.success) {
                                    ...
                                    resolve(response.message); // ✅ Send only the message string
                                } else {
                                    Swal.showValidationMessage(response.message || "Failed to reject invoice.");
                                    reject();
                                }
                            },
                ...
                if (result.isConfirmed) {
                    Swal.fire('Verified!', result.value || 'Invoice verified.', 'success')
                        .then(() => {
                            window.location.href = "invoice-application.php";
                        });
                }

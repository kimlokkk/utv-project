...
<body class="skin-green fixed-layout">
                    ...
                    <div class="col-12">
                        <div class="vendor-info-card">
                                ...
                                <div class="info-grid">
                                    <div class="info-item">
                                        ...
                                        <div class="info-value" style="color: #dc3545;">
                                            <?php 
                                                // Extract reason from status (e.g., "Reject-Poor documentation" -> "Poor documentation")
                                                $reason = strpos($status, 'Reject-') === 0 ? substr($status, 7) : 'No reason provided';
                            ...
                            <div class="action-buttons">
                                <a href="vendor.php" class="btn-custom btn-back">
                                    <i class="fas fa-arrow-left"></i>
                                    Back to List
                                </a>
                                <?php if($status == 'Verified' || strpos($status, 'Reject') === 0): ?>
                                    <button type="button" class="btn-custom btn-reject" disabled style="opacity: 0.5; cursor: not-allowed;">
                                        <i class="fas fa-times"></i>
                                        Reject
                                    </button>
                                    <button type="button" class="btn-custom btn-verify" disabled style="opacity: 0.5; cursor: not-allowed;">
                                        <i class="fas fa-check"></i>
                                        Verify
                                    </button>
                                <?php else: ?>
                                    <button type="button" class="btn-custom btn-reject" onclick="rejectVendor(<?php echo $id; ?>)">
                                        <i class="fas fa-times"></i>
                                        Reject
                                    </button>
                                    <button type="button" class="btn-custom btn-verify" onclick="verifyVendor(<?php echo $id; ?>)">
                                        <i class="fas fa-check"></i>
                                        Verify
                                    </button>
                                <?php endif; ?>
    ...
    <script>
        function verifyVendor(vendorId) {
            Swal.fire({
                title: 'Verify Vendor',
                text: 'Are you sure you want to verify this vendor?',
                icon: 'question',
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        title: 'Processing...',
                        text: 'Verifying vendor, please wait.',
                        icon: 'info',
                    ...
                    // AJAX request to verify vendor
                    $.ajax({
                        url: 'process_vendor_verification.php',
                        type: 'POST',
                        data: {
                            action: 'verify',
                            vendor_id: vendorId
                        ...
                        success: function(response) {
                            ...
                            if (response.success) {
                                ...
                                Swal.fire({
                                    title: 'Error!',
                                    text: response.message || 'Failed to verify vendor.',
                                    icon: 'error',
        ...
        function rejectVendor(vendorId) {
            Swal.fire({
                ...
                confirmButtonColor: '#dc3545',
                cancelButtonColor: '#6c757d',
                confirmButtonText: '<i class="fas fa-times"></i> Reject Vendor',
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        title: 'Are you sure?',
                        text: 'This vendor will be rejected with the reason: "' + reason + '"',
                        icon: 'warning',
                        showCancelButton: true,
                        confirmButtonColor: '#dc3545',
                        cancelButtonColor: '#6c757d',
                        ...
                        if (confirmResult.isConfirmed) {
                            ...
                            Swal.fire({
                                title: 'Processing...',
                                text: 'Rejecting vendor, please wait.',
                                icon: 'info',
                                allowOutsideClick: false,
                                allowEscapeKey: false,
                                showConfirmButton: false,
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    if (response.success) {
                                        ...
                                        Swal.fire({
                                            title: 'Error!',
                                            text: response.message || 'Failed to reject vendor.',
                                            icon: 'error',
                                            confirmButtonColor: '#dc3545',
                                            confirmButtonText: 'OK'
                                        });

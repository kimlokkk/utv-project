...
try {
    ...
    */
    ...
    $tracker_description = mysqli_real_escape_string($db, "Invoice application has been updated by Admin Level 2 ($admin_staff_id).");
    $tracker_query = "
    ...
    // Remove new uploaded files if DB update failed
    if (!empty($new_uploaded_files)) {

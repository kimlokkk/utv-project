                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <button 
                                                        ...
                                                        data-amount="<?php echo urlencode($amount); ?>" 
    ...
    <script>
        $(document).on('click', '#returnApplication', function () {
            Swal.fire({
                ...
                html: `
                    <textarea id="remarkText" class="swal2-textarea" placeholder="Enter your remarks here..."></textarea>
                    <select id="returnToSelect" class="swal2-select" style="margin-top:10px;">
                        <option value="" disabled selected>Return to...</option>
                ...
                preConfirm: () => {
                    ...
                    if (!remark) {
                        Swal.showValidationMessage('You must provide a remark!');
                    } else if (!returnTo) {
                        Swal.showValidationMessage('You must select who to return to!');
                    }
            
                    return { remark: remark, returnTo: returnTo };
                }
            }).then((result) => {
                if (result.isConfirmed) {
                    const { remark, returnTo } = result.value;
        ...
        $(document).on('click', '#approveApplication', function () {
            Swal.fire({
                ...
                if (result.value) { // Jika pengguna mengesahkan
                    ...
                    Swal.fire(
                        'Cancelled',
                        'Professional fee application approval has been cancelled.',
                        'info'
                    );
                }
            });

...
if (!$result || mysqli_num_rows($result) === 0) {
    echo '<script>alert("This application cannot be edited by Level 2."); window.location.href = "project-funding.php";</script>';
    exit;
}
            ...
            <div class="container-fluid">
                ...
                <form id="projectFundingEditForm">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="alert alert-info">Update this application while it is pending Level 2 approval.</div>
                            <div class="row">
                    ...
                    <div class="row m-t-30 m-b-30">
                        <div class="col-md-12">
                            <button type="button" id="submitProjectFundingEdit" class="btn btn-lg btn-success">Update</button>

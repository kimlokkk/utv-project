                                    ...
                                    <table class="table table-bordered table-striped" id="reconciliationTable">
                                        ...
                                        <tbody>
                                            ...
                                            $query2 = "
                                                ...
                                                WHERE rc.status NOT LIKE '%project leader%'
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a class="btn btn-warning btn-sm"
                                                       href="reconciliation-edit.php?applicationId=<?php echo urlencode($application_id); ?>">
                                                        Edit
                                                    </a>
                                                    <button 
                                                        type="button" 
        ...
        $(document).on('click', '#returnApplication', function () {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Prompt for return_to and remarks
                    Swal.fire({
                        ...
                        if (remarkResult.isConfirmed) {
                            ...
                            $.ajax({
                                ...
                                error: function (xhr, status, error) {
                                    ...
                                    Swal.fire(
                                        'Error!',
                                        'An error occurred during return process. Please check the console for details.',
                                        'error'
                                    );
                                }
                            });
                        ...
                        console.error("Error during return modal:", error);
                        Swal.fire(
                            'Error!',

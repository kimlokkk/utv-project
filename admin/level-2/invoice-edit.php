                ...
                <div class="row">
                    <div class="col-md-12">
                        <form method="POST" id="invoiceForm" enctype="multipart/form-data">
                            ...
                            <!-- Invoice Purpose -->
                            <div class="card">
                                <h3 class="card-header bg-success text-white">Invoice Purpose</h3>
                                <div class="card-body">
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-12">
                            ...
                            <div class="card">
                                <h3 class="card-header bg-success text-white">Invoice Details</h3>
                                <div class="card-body">
                                    <div class="form-body">
                                        <!-- Follow milestone? -->
                                        <div class="row">
                            ...
                            <!--Declaration-->
                            <div class="card">
                                <h3 class="card-header bg-success text-white">Admin Declaration</h3>
                                <div class="card-body">
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <ul>
                                                    <li>I have reviewed and edited this invoice application as Admin Level 3.</li>
                                                    <li>The invoice details updated above are based on the latest verified information.</li>
                            ...
                            <div class="row m-t-30 m-b-30">
                                <div class="col-md-12">
                                    <button type="button" id="updateInvoice" class="btn btn-lg btn-success">
                                        Update Invoice
                                    </button>

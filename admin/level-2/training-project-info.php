    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php
                    $isVerifiedOrPending = in_array($project_status, ['Returned', 'Approved', 'Appointed']);
                    $isAppointOrPending = in_array($project_status, ['Returned', 'Appointed']);
                ?>
                <div class="row">
                    <div class="m-b-20 col-md-12">
                        ...
                        <button type="button"
                                id="btnAppoint"
                                class="btn btn-lg btn-success"
                                <?php echo $isAppointOrPending ? 'disabled style="opacity: 0.5; cursor: not-allowed;"' : ''; ?>>
                            Appoint
                        </button>&nbsp;&nbsp;
                        <button type="button" 
                                id="btnReturn" 
            ...
            Swal.fire({
                ...
                html: `
                    <div style="text-align: left;">
                        <label for="returnTo"><strong>Return To:</strong></label>
                        <select id="returnTo" class="swal2-input" style="width: 100%; margin-bottom: 15px;">
                        ...
                        <textarea id="remark" class="swal2-textarea" placeholder="Enter your remarks here..." style="width: 100%; height: 100px;"></textarea>
                    </div>
                `,
                focusConfirm: false,
                ...
                preConfirm: () => {
                    ...
                    if (!returnTo || !remark) {
                        Swal.showValidationMessage('Please select return destination and enter remark.');
                    }
                ...
                if (result.isConfirmed) {
                    ...
                    formData.append('return_to', result.value.returnTo);
        ...
        document.getElementById('btnApprove').addEventListener('click', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = `training-project-approve.php?id=${projectId}`;
                }
            });
        });
    </script>
    <script>
        document.getElementById('btnAppoint').addEventListener('click', function (e) {
            e.preventDefault();
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Redirect to consultancy_project_verify.php with the project ID
                    const projectId = "<?php echo $id; ?>"; // Get project ID dynamically
                    window.location.href = `training-project-appoint.php?id=${projectId}`;
                }
            });
        });
    </script>

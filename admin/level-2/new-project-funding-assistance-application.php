            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Pending Project Funding Assistance Application</h4>
                    </div>
                                    ...
                                    <table class="table table-bordered table-striped" id="projectFundingTable">
                                        ...
                                        <tbody>
                                            ...
                                            $query2 = "
                                                ...
                                                WHERE pfa.status = 'Pending Approval'
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <?php
                                                    $isRejected = stripos($status, 'Returned') !== false;
                    ...
                    Swal.fire({
                        ...
                        html: `
                            <select id="returnToSelect" class="swal2-select" style="margin-bottom:10px;width:100%;">
                                <option value="" disabled selected>Select return target</option>

...
<body class="skin-green fixed-layout">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="project_leader" value="<?php echo $project_leader; ?>">
                            <input type="hidden" name="project_no" value="<?php echo $project_no; ?>">
                            <!-- Project Details -->
                            <div class="card">
                                <h3 class="card-header bg-success text-white">Consultancy Project</h3>
                                <div class="card-body">
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="project_title" value="<?php echo $project_title; ?>" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="project_start" value="<?php echo $project_start; ?>" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Project End <span class="text-danger">*</span></label>
                                                    <input type="date" name="project_end" value="<?php echo $project_end; ?>" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="registered_project_value" value="<?php echo $registered_project_value; ?>" class="form-control" min="1" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Adjusted Project Value (RM)</label>
                                                    <input type="number" name="adjusted_project_value" id="adjusted_project_value_top" value="<?php echo $adjusted_project_value; ?>" class="form-control" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="quotation_ref_no" value="<?php echo $quotation_ref_no; ?>" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <h3 class="card-header bg-success text-white">Members</h3>
                                <div class="card-body">
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-12">
                            ...
                            <div class="card">
                                <h3 class="card-header bg-success text-white">Project Timeline</h3>
                                <div class="card-body">
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                        ...
                                                        <table class="table table-bordered" id="dynamic_field_timeline">
                                                                ...
                                                                <?php if (!empty($existing_timeline)) { ?>
                                                                    <?php foreach ($existing_timeline as $timelineIndex => $timeline) { $rowNo = $timelineIndex + 1; ?>
                                                                        <tr id="row<?php echo $rowNo; ?>">
                                                                            <td style="width: 20%;">
                                                                                <input type="hidden" name="project_timeline[<?php echo $rowNo; ?>][id]" value="<?php echo $timeline['id']; ?>">
                                                                                <input type="text" name="project_timeline[<?php echo $rowNo; ?>][title]" class="form-control" placeholder="Title" value="<?php echo htmlspecialchars($timeline['title']); ?>" required>
                                                                            </td>
                                                                            <td style="width: 35%;">
                                                                                <input type="text" name="project_timeline[<?php echo $rowNo; ?>][description]" class="form-control" placeholder="Description" value="<?php echo htmlspecialchars($timeline['description']); ?>" required>
                                                                            </td>
                                                                            <td style="width: 15%;">
                                                                                <input type="number" step="0.01" min="0" name="project_timeline[<?php echo $rowNo; ?>][value]" class="form-control timeline-value" placeholder="Value (RM)" value="<?php echo htmlspecialchars($timeline['value']); ?>" required>
                                                                            </td>
                                                                            <td style="width: 10%;">
                                                                                <input type="date" name="project_timeline[<?php echo $rowNo; ?>][date_start]" class="form-control timeline-start" value="<?php echo htmlspecialchars($timeline['date_start']); ?>" required>
                                                                            </td>
                                                                            <td style="width: 10%;">
                                                                                <input type="date" name="project_timeline[<?php echo $rowNo; ?>][date_end]" class="form-control timeline-end" value="<?php echo htmlspecialchars($timeline['date_end']); ?>" required>
                                                                            </td>
                                                            ...
                                                            <tfoot>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="number" step="0.01" id="adjusted_project_value_display" value="<?php echo htmlspecialchars($adjusted_project_value); ?>" class="form-control" readonly>
                                                                    </td>
                                                                    <td colspan="3"></td>
                                                                </tr>
                                                            </tfoot>
                            ...
                            <div class="card">
                                <h3 class="card-header bg-success text-white">Project-Related File Uploads</h3>
                                <div class="card-body">
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6">
                            ...
                            <!-- Client Information -->
                            <div class="card">
                                <h3 class="card-header bg-success text-white">Client Information</h3>
                                <div class="card-body">
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="client_company_name" value="<?php echo $client_company_name; ?>" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Full Address <span class="text-danger">*</span></label>
                                                    <input type="text" name="client_address" value="<?php echo $client_address; ?>" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="client_contact" value="<?php echo $client_contact; ?>" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="client_business_type" required>
                                                        <option value="<?php echo $client_business_type; ?>"><?php echo $client_business_type; ?></option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="client_pic" value="<?php echo $client_pic; ?>" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Person in Charge Email Address <span class="text-danger">*</span></label>
                                                    <input type="email" name="client_pic_email" value="<?php echo $client_pic_email; ?>" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Person in Charge Contact Number <span class="text-danger">*</span></label>
                                                    <input type="phone" name="client_pic_contact" value="<?php echo $client_pic_contact; ?>" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row m-t-30 m-b-30">
                                <div class="col-md-12">
                                    ...
                                    <button 
                                      type="submit"
                                      name="btn_updateConsultancyProject"
                                      class="btn btn-lg btn-info"
                                      formnovalidate
                                      onclick="document.getElementById('action').value='save';"
                                    >Save</button>
                                    <!--<button type="submit" name="btn_submitConsultancyProject" class="btn btn-lg btn-success"> Submit</button>-->
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const submitButton = document.querySelector("button[name='btn_submitConsultancyProject']");
                ...
                const newRow = `
                    <tr>
                        <td style="width: 80%;">
                            <select class="select2 form-control custom-select member-select" name="project_members[]">
                                <option disabled selected>Select Members</option>
                                <?php echo addslashes($staffOptions); ?>
                            </select>
                        </td>
                        <td class="text-center">
                            <button type="button" class="btn btn-danger btn_remove_member">Remove</button>
            ...
            $(document).on('click', '#add_timeline', function () {
                ...
                const newRow = `
                    <tr id="row${timelineRowIndex}">
                        <td style="width: 20%;"><input type="text" name="project_timeline[${timelineRowIndex}][title]" class="form-control" placeholder="Title" required></td>
                        <td style="width: 35%;"><input type="text" name="project_timeline[${timelineRowIndex}][description]" class="form-control" placeholder="Description" required></td>
                        <td style="width: 15%;"><input type="number" step="0.01" min="0" name="project_timeline[${timelineRowIndex}][value]" class="form-control timeline-value" placeholder="Value (RM)" required></td>
                        <td style="width: 10%;"><input type="date" name="project_timeline[${timelineRowIndex}][date_start]" class="form-control timeline-start" required></td>
                        <td style="width: 10%;"><input type="date" name="project_timeline[${timelineRowIndex}][date_end]" class="form-control timeline-end" required></td>
                        <td class="text-center" style="width: 10%;"><button type="button" class="btn btn-danger btn_remove_timeline">Remove</button></td>
                    </tr>`;

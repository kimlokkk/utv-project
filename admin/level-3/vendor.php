            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Vendor Status</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Vendor Registration</a></li>
                                <li class="breadcrumb-item active">Vendor Status</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <h3 class="card-header bg-success text-white">Vendor Registration Status</h3>
                            <div class="card-body">
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars($contact_name); ?></td>
                                                <td><?php echo htmlspecialchars($contact_phone); ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    if (stripos($status, 'Rejected') !== false || stripos($status, 'Returned') !== false || stripos($status, 'Reject') !== false) {
                                                ...
                                                <td class="text-center">
                                                    <a href="vendor-info.php?id=<?php echo urlencode($id); ?>" 

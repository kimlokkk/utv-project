<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') { // Gunakan GET
        ...
        $remark = "Project funding assistance application has been verified by admin ($staff_id)";
        ...
        try {
            ...
            echo json_encode(['success' => true, 'message' => "Project funding assistance application has been successfully verified !"]);
        } catch (Exception $e) {

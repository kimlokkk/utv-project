<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') { // Gunakan GET
        ...
        $remark = "Research assistant application for $research_name has been verified by admin ($staff_id).";
        ...
        try {
            ...
            echo json_encode(['success' => true, 'message' => 'Research assistant application has been successfully verified !']);
        } catch (Exception $e) {

...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        // Step 1: Dapatkan name
        $member_query = "SELECT name FROM allowance_applications WHERE id = '$application_id'";
        ...
        // Step 2: Keep status clean and send it back to consultant for correction.

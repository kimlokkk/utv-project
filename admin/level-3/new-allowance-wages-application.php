                                    ...
                                    <table class="table table-bordered table-striped" id="professionalTable">
                                        ...
                                        <tbody>
                                            ...
                                            $query2 = "
                                                ...
                                                WHERE aa.status = 'Pending Verification' OR ((aa.status LIKE '%Returned%' OR aa.status = 'Rejected') AND aa.return_to = 'Level 3')
                                                ORDER BY aa.id DESC";
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <?php
                                                    $isReturnedToLevel3 = strcasecmp(trim((string)($row['return_to'] ?? '')), 'Level 3') === 0 && (stripos($status, 'Rejected') !== false || stripos($status, 'Returned') !== false);

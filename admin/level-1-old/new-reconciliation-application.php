            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">New Advance & Reconciliation/ Claim Application</h4>
                    </div>
                                    ...
                                    <table class="table table-bordered table-striped" id="professionalTable">
                                        ...
                                        <tbody>
                                            ...
                                            $query2 = "
                                                ...
                                                WHERE rc.status = 'Pending Verification' OR rc.status = 'Pending Approval'
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button 
                                                        ...
                                                        <?php if ($status !== 'Pending Verification') echo 'disabled'; ?>>
                                                        Verify
                                                    </button>
                                                    <button 
                                                        type="button" 
                                                        ...
                                                        data-application-id="<?php echo urlencode($application_id); ?>"
                                                        data-application-type="<?php echo urlencode($application_type); ?>"
                                                        <?php if ($status !== 'Pending Approval') echo 'disabled'; ?>>
                                                        Approve
                                                    </button>
                                                    <button 
                                                        type="button" 
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        ...
                        if (remarkResult.isConfirmed) {
                            ...
                            Swal.fire(
                                'Cancelled',
                                'You need to provide a remark to reject the advance & reconciliation/claim application.',
                                'info'
                            );
                        }
                    }).catch((error) => {
                    ...
                    Swal.fire(
                        'Cancelled',
                        'Advance & reconciliation/claim application rejection has been cancelled.',
                        'info'
                    );
                }
            });
        ...
        $(document).on('click', '#verifyApplication', function () {
            Swal.fire({
                ...
                if (result.value) { // Jika pengguna mengesahkan
                    ...
                    Swal.fire(
                        'Cancelled',
                        'Advance & reconciliation/claim application verification has been cancelled.',
                        'info'
                    );
                }
            });
        ...
        $(document).on('click', '#approveApplication', function () {
            Swal.fire({
                ...
                if (result.value) { // Jika pengguna mengesahkan
                    ...
                    // Hantar permintaan AJAX ke server
                    $.ajax({
                        url: 'reconciliation-approve.php',
                        method: 'GET', // Gunakan GET seperti yang diminta
                        data: {
                            applicationId: applicationId,
                            applicationType: applicationType,
                    ...
                    Swal.fire(
                        'Cancelled',
                        'Advance & reconciliation/claim application approval has been cancelled.',
                        'info'
                    );
                }
            });

...
?>
<?php
    // Fetch Research Assistants related to the project
    $project_query = "SELECT id, project_no, project_title, client_company_name, project_type FROM project";
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><strong>Search Project No</strong></label>
                                        <select name="project_id" id="projectSelect" class="select2 form-control custom-select">
                                            <option value="" disabled selected>Select Project</option>
                                            <?php while($project = mysqli_fetch_assoc($project_result)): ?>
                                                <option value="<?php echo $project['id']; ?>" 
                                                    data-client-company-name="<?php echo $project['client_company_name']; ?>"
                                                    data-project-type="<?php echo $project['project_type']; ?>">
                                                    <?php echo $project['project_no']; ?> - <?php echo $project['project_title']; ?>
                                                </option>
                                            <?php endwhile; ?>
                                        </select>
                                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#projectSelect').on('change', function () {
                ...
                var clientName = selectedOption.data('client-company-name');
                var projectType = selectedOption.data('project-type');
        
                $('#clientCompanyName').val(clientName);

<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') { // Gunakan GET
        ...
        $remark = "$application_type application has been approved by admin.";
        ...
        try {
            ...
            echo json_encode(['success' => true, 'message' => "$application_type application has been successfully approved !"]);
        } catch (Exception $e) {

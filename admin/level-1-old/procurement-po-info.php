...
<?php
    ...
    $query = "SELECT 
            ...
            INNER JOIN procurement_criteria pcr ON pr.id = pcr.procurement_id
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <!-- Criteria -->
                        <div class="card">
                            <h3 class="card-header bg-success text-white">Criteria</h3>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><?php echo htmlspecialchars($criteria); ?></th>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>

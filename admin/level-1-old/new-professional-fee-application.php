...
<body class="skin-green fixed-layout">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">New Professional Fee Application</h4>
                    </div>
                                    ...
                                    <table class="table table-bordered table-striped" id="professionalTable">
                                        ...
                                        <tbody>
                                            ...
                                            $query2 = "
                                                ...
                                                WHERE pf.status = 'Pending Verification' OR pf.status = 'Pending Approval'
                                                ORDER BY pf.id DESC";
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button 
                                                        ...
                                                        data-member-name="<?php echo urlencode($member_name); ?>" 
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="viewDetailsModalLabel">Professional Fee Details</h5>
    ...
    <script>
        $(document).on('click', '.viewDetails', function () {
            ...
            $.ajax({
                url: 'get-professional-fee-details.php',
                method: 'POST',

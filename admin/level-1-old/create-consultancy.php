                        ...
                        <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <select class="form-control" name="stud_oku" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="name" value="<?php echo isset($_POST['stud_email']) ? $_POST['stud_email'] : '' ?>" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Project End <span class="text-danger">*</span></label>
                                                    <input type="date" name="stud_email" value="<?php echo isset($_POST['stud_email']) ? $_POST['stud_email'] : '' ?>" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="name" value="<?php echo isset($_POST['stud_email']) ? $_POST['stud_email'] : '' ?>" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Adjusted Project value (RM)</label>
                                                    <input type="number" name="stud_email" value="<?php echo isset($_POST['stud_email']) ? $_POST['stud_email'] : '' ?>" class="form-control" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Add Members (Consultant) <span class="text-danger">*</span></label>
                                                    <div class="table-responsive">  
                                                        <table class="table table-bordered" id="dynamic_field">  
                                                            <tr>
                                                                <td style="width: 80%;">
                                                                    <select class="select2 form-control custom-select" name="stud_therapist[]"  required>
                                                                ...
                                                                <td class="text-center"><button type="button" name="add" id="add" class="btn btn-info">Add More</button></td>  
                                                            </tr>  
                                                        </table>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Project Timeline / Milestone <span class="text-danger">*</span></label>
                                                    <div class="table-responsive">  
                                                        <table class="table table-bordered" id="dynamic_field2">  
                                                            <tr>
                                                                <td style="width: 50%;">
                                                                    <input type="text" class="form-control" name="project_timeline[]" placeholder="Enter Project Timeline" required />
                                                                </td>
                                                                <td style="width: 30%;">
                                                                    <input type="text" class="form-control" name="project_value[]" placeholder="Enter Value (RM)" required />
                                                                </td>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="stud_email" value="<?php echo isset($_POST['stud_email']) ? $_POST['stud_email'] : '' ?>" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="form-body">
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            <input type="file" name="news_img" class="custom-file-input" id="inputGroupFile01" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            <input type="file" name="news_img" class="custom-file-input" id="inputGroupFile02" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            <input type="file" name="news_img" class="custom-file-input" id="inputGroupFile03" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            <input type="file" name="news_img" class="custom-file-input" id="inputGroupFile04">
                                                            <label class="custom-file-label" for="inputGroupFile02">Choose File</label>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Project Proposal & Budget <span class="text-danger">*</span></label>
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            <input type="file" name="news_img" class="custom-file-input" id="inputGroupFile05" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            <input type="file" name="news_img" class="custom-file-input" id="inputGroupFile06">
                                                            <label class="custom-file-label" for="inputGroupFile05">Choose File</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            <input type="file" name="news_img" class="custom-file-input" id="inputGroupFile07">
                                ...
                                <div class="card-body">
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Clients Company Name <span class="text-danger">*</span></label>
                                                    <input type="text" name="name" value="<?php echo isset($_POST['stud_email']) ? $_POST['stud_email'] : '' ?>" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Contat Number <span class="text-danger">*</span></label>
                                                    <input type="text" name="stud_email" value="<?php echo isset($_POST['stud_email']) ? $_POST['stud_email'] : '' ?>" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="stud_email" value="<?php echo isset($_POST['stud_email']) ? $_POST['stud_email'] : '' ?>" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">Person in Charge Contact Number <span class="text-danger">*</span></label>
                                                    <input type="phone" name="stud_email" value="<?php echo isset($_POST['stud_email']) ? $_POST['stud_email'] : '' ?>" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row m-t-30 m-b-30">
                                <div class="col-md-12">
                                    ...
                                    <button type="save" class="btn btn-lg btn-info"> Save</button>&nbsp;&nbsp;

                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $query = "SELECT 
                                                          ...
                                                          WHERE p.project_status IN ('Approved') 
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars($invoice_status); ?></td>
                                                ...
                                                <td class="text-center">
                                                    <a href="update-invoice.php?invoiceId=<?php echo urlencode($invoice_id); ?>&projectId=<?php echo urlencode($project_id); ?>" class="btn waves-effect waves-light btn-info assign-button" title="Update Invoice">Update Invoice</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>

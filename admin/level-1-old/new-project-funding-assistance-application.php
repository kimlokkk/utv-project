            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">New Project Funding Assistance Application</h4>
                    </div>
                                    ...
                                    <table class="table table-bordered table-striped" id="professionalTable">
                                        ...
                                        <tbody>
                                            ...
                                            $query2 = "
                                                ...
                                                WHERE pfa.status = 'Pending Verification' OR pfa.status = 'Pending Approval'
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars($expected_payment_date); ?></td>

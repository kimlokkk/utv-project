...
<body class="skin-green fixed-layout">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <ul class="nav nav-tabs customtab" role="tablist">
                                                ...
                                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#project-ledger" role="tab"><span class="hidden-sm-up"></i></span> <span class="hidden-xs-down">Project Ledger</span></a> </li>
                                            </ul>
                                            <!-- Tab panes -->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <button type="button" id="btnReturn" class="btn btn-lg btn-danger">Return</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    document.getElementById('btnApprove').addEventListener('click', function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = `consultancy-project-approve.php?id=${projectId}`;
            }
        });
    });
    </script>
    ...
    <script>
        $(document).ready(function() {
            var projectId = "<?php echo $id; ?>"; // Ambil project_id dari PHP
            ...
            if (projectId) {
                fetchLedgerData(projectId);
            }
    
            function fetchLedgerData(projectId) {
                $.ajax({
                    url: 'fetch_project_ledger.php',
                    method: 'GET',

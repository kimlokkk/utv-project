...
<?php
    ...
    {
        if (stripos($status, 'Returned') !== false) {
            return 'Returned to Level 4';
        } elseif (stripos($status, 'Pending Verification') !== false) {
            return 'Level 4 Verification';
        } elseif (stripos($status, 'Pending Approval') !== false) {
...
<?php
    /* ==============================================================
       Dashboard counts - Pending Verification and Returned to Level 4
       ============================================================== */
    ...
    $new_projects_query = "
        ...
        FROM project
        WHERE (project_status = 'Pending Verification' OR (project_status = 'Returned' AND return_to = 'Level 4'))
    ";
    ...
    $returned_projects_query = "
        ...
        FROM project
        WHERE project_status = 'Returned' AND return_to = 'Level 4'
    ";
    ...
    $pending_ra_query = "SELECT COUNT(*) AS pending_ra FROM research_assistant WHERE status = 'Pending Verification' OR (status LIKE '%Returned%' AND return_to = 'Level 4')";
    ...
    $returned_ra_registration_query = "SELECT COUNT(*) AS returned_ra_registration FROM research_assistant WHERE status LIKE '%Returned%' AND return_to = 'Level 4'";
    ...
    $pending_members_query = "
        ...
        WHERE status = 'Pending Verification' OR ((status LIKE '%Returned%' OR status = 'Rejected') AND return_to = 'Level 4')
    ";
    ...
    $returned_members_query = "
        ...
        FROM research_assistant_application 
        WHERE (status LIKE '%Returned%' OR status = 'Rejected') AND return_to = 'Level 4'
    ";
    ...
    $pending_invoice_query = "
        ...
        FROM invoices 
        WHERE invoice_status = 'Pending Verification' OR (invoice_status LIKE '%Returned%' AND return_to = 'Level 4')
    ";
    ...
    $returned_invoice_query = "
        ...
        FROM invoices 
        WHERE invoice_status LIKE '%Returned%' AND return_to = 'Level 4'
    ";
    ...
    $pending_professional_query = "
        ...
        WHERE status = 'Pending Verification' OR (status = 'Rejected' AND return_to = 'Level 4')
    ";
    ...
    $returned_professional_query = "
        ...
        FROM professional_fee_applications 
        WHERE status = 'Rejected' AND return_to = 'Level 4'
    ";
    ...
    $pending_reconciliation_query = "
        ...
        WHERE status = 'Pending Verification' OR (status LIKE '%Returned%' AND return_to = 'Level 4')
    ";
    ...
    $returned_reconciliation_query = "
        ...
        FROM reconciliation_claim_applications 
        WHERE status LIKE '%Returned%' AND return_to = 'Level 4'
    ";
                ...
                <div class="dashboard-hero">
                    <div class="dashboard-hero-content">
                        <div class="row align-items-center">
                            <div class="col-lg-8">
                                <h2>Level 4 Action Dashboard</h2>
                            ...
                            <div class="col-lg-4 text-lg-right m-t-20 m-t-lg-0">
                                <span class="badge badge-light" style="font-size:13px;padding:10px 14px;border-radius:999px;">Current Scope: Level4 Verification</span>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        ...
                                        <p class="summary-help">All pending or returned items under Level 4.</p>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        ...
                                        <p class="summary-help">Items waiting for Level 4 review.</p>
                                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 m-b-20">
                        <div class="card summary-card summary-danger">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        <div class="summary-label">Returned to Level 4</div>
                    ...
                    <div class="col-12">
                        <div class="card section-card">
                            <div class="card-header bg-success text-white">
                                ...
                                <div class="section-subtitle">Projects that require Level 4 verification or returned-item review.</div>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-12">
                        <div class="card section-card">
                            <div class="card-header bg-success text-white">
                                ...
                                <div class="section-subtitle">New RA/RO registrations pending verification or returned to Level 4.</div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $query = "
                                                    ...
                                                    WHERE 
                                                        raa.status = 'Pending Verification' OR ((raa.status LIKE '%Returned%' OR raa.status = 'Rejected') AND raa.return_to = 'Level 4')
                                                ...
                                                if ($result && mysqli_num_rows($result) > 0) {
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        $isReturnedToLevel3 = strcasecmp($return_to, 'Level 4') === 0 && (stripos($status, 'Returned') !== false || stripos($status, 'Rejected') !== false);
                                                        $statusClass = statusBadgeClass($status);
                                                        ...
                                                        $stageText = $isReturnedToLevel3 ? 'Returned to Level 4' : stageLabel($status);
                                            ?>
                                            <tr>

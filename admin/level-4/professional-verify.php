<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') { // Gunakan GET
        ...
        $remark = "Professional fee application for $member_name has been verified by admin ($staff_id).";
        ...
        try {
            ...
            echo json_encode(['success' => true, 'message' => 'Professional fee application has been successfully verified !']);
        } catch (Exception $e) {

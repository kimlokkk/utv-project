...
<body class="skin-green fixed-layout">
                                    ...
                                    <table class="table table-bordered table-striped" id="projectFundingTable">
                                        ...
                                        <tbody>
                                            ...
                                            $query2 = "
                                                ...
                                                WHERE pfa.status NOT LIKE '%project leader%'
                                                  AND NOT (
                                                      (pfa.status LIKE '%Returned%' OR pfa.status LIKE '%Rejected%')
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <?php if ((stripos($status, 'Rejected') !== false || stripos($status, 'Returned') !== false) && strcasecmp($return_to, 'Level 3') === 0) { ?>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    ?>
                                                    <button type="button" class="btn btn-info btn-sm" id="verifyProjectFunding" 
                                                        data-application-id="<?php echo urlencode($application_id); ?>" 
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-sm" id="rejectProjectFunding" 
                                                        data-application-id="<?php echo urlencode($application_id); ?>" 
                                                        data-project-id="<?php echo urlencode($project_id); ?>" 
                                                        data-project-no="<?php echo urlencode($project_no); ?>"
                                                        data-admin-staff-id="<?php echo $userData['staff_id']; ?>"
                                ...
                                <form id="selectProjectForm">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="projectSelect" name="projectId" required>
                                            ...
                                            <?php 
                                            $projectQuery = "SELECT id, project_no, project_title FROM project WHERE leader_id = '{$userData['id']}'";
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        ...
                        if (remarkResult.isConfirmed) {
                            ...
                            $.ajax({
                                url: 'project-funding-reject.php',
                                method: 'POST',
                                data: {
                            ...
                            Swal.fire(
                                'Cancelled',
                                'You need to provide a remark to reject the project funding assistance application.',
                                'info'
                            );
                        }
                    }).catch((error) => {
                    ...
                    Swal.fire(
                        'Cancelled',
                        'Project funding assistance application rejection has been cancelled.',
                        'info'
                    );
                }
            });
    ...
    <script>
        $(document).on('click', '#verifyProjectFunding', function () {
            Swal.fire({
                title: 'Are you sure?',
                ...
                if (result.value) { // Jika pengguna mengesahkan
                    ...
                    // Hantar permintaan AJAX ke server
                    $.ajax({
                        url: 'project-funding-verify.php',
                    ...
                    Swal.fire(
                        'Cancelled',
                        'Project funding assistance application verification has been cancelled.',
                        'info'
                    );
                }
            });

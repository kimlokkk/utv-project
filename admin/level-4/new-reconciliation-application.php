            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Pending Advance & Reconciliation/ Claim Application</h4>
                    </div>
                                    ...
                                    <table class="table table-bordered table-striped" id="reconciliationTable">
                                        ...
                                        <tbody>
                                            ...
                                            $query2 = "
                                                ...
                                                WHERE rc.status = 'Pending Verification' OR (rc.status LIKE '%Returned%' AND rc.return_to = 'Level 4')

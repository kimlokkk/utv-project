            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <!-- Submit Buttons -->
                        <?php
                        $normalizedStatus = strtolower(trim($invoice_status));
                        
                        // Tukar value ini ikut status sebenar yang membenarkan admin verify/reject
                        $allowedActionStatuses = [
                            'Pending Verification'
                        ];
                        
                        // Verify & Reject hanya boleh ditekan semasa status masih menunggu verification
                        $disableButtons = !in_array($normalizedStatus, $allowedActionStatuses, true);
                        ?>

...
<body class="skin-green fixed-layout">
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            $disableButtons = $isRejected || $isPendingApproval || $isSendToBank;
                                                            ?>
                                                            <button type="button" class="btn btn-success btn-sm" id="completeProjectFunding"
                                                                data-application-id="<?php echo urlencode($application_id); ?>"
    ...
    <script>
        $(document).on('click', '#completeProjectFunding', function() {
            Swal.fire({
                title: 'Are you sure?',
                text: "Once complete, you cannot edit this!",
                icon: 'warning',
                ...
                if (result.value) { // Jika pengguna mengesahkan
                    ...
                    $.ajax({
                        url: 'project-funding-complete.php',
                    ...
                    Swal.fire(
                        'Cancelled',
                        'Project funding assistance application completion has been cancelled.',
                        'info'
                    );
                }
            });

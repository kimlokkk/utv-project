                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $query = "SELECT 
                                                        ...
                                                        WHERE p.project_status IN ('Approved', 'Appointed')
                                                          ...
                                                          AND i.invoice_status NOT LIKE '%Leader Review%'
                                                        ORDER BY i.id DESC
                                                        ";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    } elseif (stripos($invoice_status, 'Approved') !== false || stripos($invoice_status, 'Waiting Payment') !== false || stripos($invoice_status, 'Send to bank') !== false || stripos($invoice_status, 'Fully Paid') !== false) {
                                                ...
                                                <td class="text-center">
                                                    <?php if (stripos($invoice_status, 'Approved') !== false || stripos($invoice_status, 'Waiting Payment') !== false): ?>
                                                        <button 
                                                    ...
                                                    <?php else: ?>
                                                        <button class="btn btn-primary" title="Only approved invoices can have documents updated" disabled>
                                                            Update Invoice Documents
                                                        </button>
                                                    <?php endif; ?>
                                                </td>

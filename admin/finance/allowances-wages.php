...
<body class="skin-green fixed-layout">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    ?>
                                                    <button type="button" class="btn btn-success btn-sm" id="completeAllowance" 
                                                        data-application-id="<?php echo urlencode($application_id); ?>" 
    ...
    <script>
        $(document).on('click', '#completeAllowance', function () {
            Swal.fire({
                title: 'Are you sure?',
                ...
                if (result.value) { // Jika pengguna mengesahkan
                    ...
                    Swal.fire(
                        'Cancelled',
                        'Allowance/wages completeion has been cancelled.',
                        'info'
                    );
                }
            });

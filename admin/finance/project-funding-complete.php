...
if ($_SERVER['REQUEST_METHOD'] === 'GET') { // Gunakan GET
    ...
    $remark = "Project funding assistance application has been completed by finance ($staff_id)";
    ...
    try {
        ...
        echo json_encode(['success' => true, 'message' => "Project funding assistance application has been successfully completed !"]);
    } catch (Exception $e) {

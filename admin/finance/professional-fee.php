                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    $disableButtons = $isRejected || $isPendingApproval || $isSendToBank || $isCompleted;
                                                    ?>
                                                    <button 
                                                        type="button" 
        ...
        $(document).on('click', '#completeApplication', function () {
            Swal.fire({
                ...
                if (result.value) { // Jika pengguna mengesahkan
                    ...
                    Swal.fire(
                        'Cancelled',
                        'Professional fee application completion has been cancelled.',
                        'info'
                    );
                }
            });

...
<body class="skin-green fixed-layout">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    $isCompleted = stripos($status, 'Completed') !== false;
                                                    $disableButtons = $isRejected || $isSendToBank || $isCompleted;
                                                    ?>
                                                    <button 
                                                        type="button" 
    ...
    <script>
        $(document).on('click', '#completeApplication', function () {
            Swal.fire({
                title: 'Are you sure?',
                text: "Once sent to bank, you cannot edit this!",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Yes, send to bank!',
                ...
                if (result.value) { // Jika pengguna mengesahkan
                    ...
                    $.ajax({
                        url: 'reconciliation-complete.php',
                    ...
                    Swal.fire(
                        'Cancelled',
                        'Advance & reconciliation/claim send to bank action has been cancelled.',
                        'info'
                    );
                }
            });

    ...
    try {
        ...
        $update_query = "UPDATE reconciliation_claim_applications 
                         SET status = 'Send to bank',
                             finance_processed_by = '$staff_id',
                             finance_processed_at = '$date'
        ...
        $remark = "$application_type application has been sent to bank by finance ($staff_id).";
        /*if ($ledger_inserted) {
        ...
        echo json_encode(['success' => true, 'message' => "$application_type application has been successfully sent to bank!"]);
    } catch (Exception $e) {
